...
def get_listener(address, port):
    ...
    class CustomHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            self.end_headers()
            self.wfile.write(bytes("<header><h1>Authentication code received!</h1></header>" +\
                                   "You may close this window now.", "utf-8"))
    ...
    except NameError:  # 'CLIENT_REQUEST' not defined before timeout
        return None
